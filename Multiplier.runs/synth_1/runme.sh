...
HD_PWD='D:/vivado/Multiplier/Multiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_muti.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_muti.tcl
