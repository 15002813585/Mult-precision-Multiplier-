...
HD_PWD='D:/vivado/Multiplier/Multiplier.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add_muti.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add_muti.tcl -notrace
